...
;(function($){$.fn.camera = function(opts, callback) {
	...
	var defaults = {
		...
		height				: '41.53%',	//here you can type pixels (for instance '300px'), a percentage (relative to the width of the slideshow, for instance '50%') or 'auto'		
		...
		minHeight			: '432px',	//you can also leave it blank		
