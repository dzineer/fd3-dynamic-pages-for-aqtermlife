    ...
    options.jq(function() {
       ...
       // ---------------------- Models ----------------------
        ...
        var SignUpChoiceModelClass = fd3ModelClass.extend({
            'loadPage': function() {
                var signUp = new SignUpChoiceViewClass();
            ...
            'eventsFired': function( e ) {
                ...
                var contactInfo = new ContactInfoControllerClass();
        ...
        // Model: ContactInfo
        var ContactInfoModelClass = fd3ModelClass.extend({
            'loadPage': function() {
            ...
            'eventsFired': function( e ) {
                var currentTarget = e.currentTarget;
                var id = currentTarget.id;
                var accountInfo = new AccountInfoControllerClass();
        ...
        // Model: AccountInfo
        var AccountInfoModelClass = fd3ModelClass.extend({
            'loadPage': function() {
            ...
            'eventsFired': function( e ) {
                var currentTarget = e.currentTarget;
                var id = currentTarget.id;
                var referencesInfo = new PreferencesInfoControllerClass();
        ...
        var PreferencesInfoModelClass = fd3ModelClass.extend({
            'loadPage': function() {
            ...
            'eventsFired': function( e ) {
                var currentTarget = e.currentTarget;
                var id = currentTarget.id;
                var agreementsInfo = new AgreementsInfoControllerClass();
                var tab = this.data.container;
        ...
        var AgreementsInfoModelClass = fd3ModelClass.extend({
            'loadPage': function() {
            ...
            'eventsFired': function( e ) {
                var currentTarget = e.currentTarget;
                var id = currentTarget.id;
                // var billingInfo = new BillingInfoControllerClass();
                var tab = this.data.container;
        ...
        // Model: BillingInfo
        var BillingInfoModelClass = fd3ModelClass.extend({
        ...
        var SignAQ2EMarketingModelClass = fd3ModelClass.extend({
        ...
        var SignUpChoiceControllerClass = fd3ControllerClass.extend({
            'index': function() {

                var signUpChoiceModel = new SignUpChoiceModelClass();

                signUpChoiceModel.init({
                    'contents': SignUpChoiceData,
                    'controllers': { 'contactInfo': new ContactInfoControllerClass() },
                    'views': { 'signUp': new SignUpChoiceViewClass() }
                });
        ...
        var ContactInfoControllerClass = fd3ControllerClass.extend({
            'index': function() {

                var contactInfo = new ContactInfoModelClass();
                contactInfo.init({
                    'contents': ContactInfoData,
                    'views': { 'contactInfo': new ContactInfoViewClass() }
                });
        ...
        var AccountInfoControllerClass = fd3ControllerClass.extend({
            'index': function() {

                var accountInfo = new AccountInfoModelClass();
                accountInfo.init({
                    'contents': AccountInfoData,
                    'views': { 'accountInfo': new AccountInfoViewClass() }
                });
        ...
        var PreferencesInfoControllerClass = fd3ControllerClass.extend({
            'index': function() {

                var preferencesInfo = new PreferencesInfoModelClass();
                preferencesInfo.init({
                    'contents': PreferencesInfoData,
                    'views': { 'preferencesInfo': new PreferencesInfoViewClass() }
                });
        ...
        var AgreementsInfoControllerClass = fd3ControllerClass.extend({
            'index': function() {

                var agreementsInfo = new AgreementsInfoModelClass();
                agreementsInfo.init({
                    'contents': AgreementsInfoData,
                    'views': { 'agreementsInfo': new AgreementsInfoViewClass() }
                });
        ...
        var BillingInfoControllerClass = fd3ControllerClass.extend({
            'index': function() {

                var billingInfo = new BillingInfoModelClass();
                billingInfo.init({
                    'contents': BillingInfoData,
                    'views': { 'billingInfo': new BillingInfoViewClass() }
                });
        ...
        var SignUpAQ2EMarketingControllerClass = fd3ControllerClass.extend({
            'index': function() {
        ...
        var InvoiceInfoData =  {
            ...
            'data': {
                ...
                'parent_container': jq('#new-sign-up-billing-info'),
        ...
        // View: SignUpChoice 
        var SignUpChoiceViewClass = FD3View.extend({
        ...
        // View: ContactInfo 
        var ContactInfoViewClass = FD3View.extend({
            'renderTitle': function() {
                var d = this.renderElement( 'div', { 'class': 'form-group' } );
                var h = this.renderElement( 'h2', { 'class': 'fd3-form-title' } );
        ...
        // View: AccountInfo 
        var AccountInfoViewClass = FD3View.extend({
            'renderTitle': function() {
                var d = this.renderElement( 'div', { 'class': 'form-group' } );
                var h = this.renderElement( 'h2', { 'class': 'fd3-form-title' } );
        ...
        var PreferencesInfoViewClass = FD3View.extend({
            'renderTitle': function() {
                var d = this.renderElement( 'div', { 'class': 'form-group' } );
                var h = this.renderElement( 'h2', { 'class': 'fd3-form-title' } );
        ...
        // View: AgreementsInfo
        var AgreementsInfoViewClass = FD3View.extend({
            'renderTitle': function() {
                var d = this.renderElement( 'div', { 'class': 'form-group' } );
                var h = this.renderElement( 'h2', { 'class': 'fd3-form-title' } );
        ...
        // View: BillingInfo
        var BillingInfoViewClass = FD3View.extend({
            'renderTitle': function() {
                var d = this.renderElement( 'div', { 'class': 'form-group' } );
                var h = this.renderElement( 'h2', { 'class': 'fd3-form-title' } );
        ...
        // View: InvoiceInfo
        var InvoiceInfoViewClass = FD3View.extend({
            'renderTitle': function() {
                var d = this.renderElement( 'div', { 'class': 'form-group' } );
                var h = this.renderElement( 'h2', { 'class': 'fd3-form-title' } );
...
/*                options.jq( "body" ).on('click', '#new-sign-up-fd3-agreements-btn', function( e ) {
            ...
            'render': function() {
                ...
                if( typeof this.data.billingData != 'undefined' ) {
                    this.items = data.billing.getItems();
                }
        ...
        var signUpChoiceContoller = new SignUpChoiceControllerClass();
