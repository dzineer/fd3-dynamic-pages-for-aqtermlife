        ...
        'f': (function() {
            return {
                ...
                getServerErrors: function() {
                    ...
                    $.jq(".fd3_forms_form_error").each(function() {
                        var eId = this.id;
...
(function(options) {
    ...
    var strength = {
        ...
        globalMessages = {
            ...
            'password1': {
                type: 'error',
                text: 'You must provide a Password!'
            },
            'password2': {
                type: 'error',
            ...
            'microsite1': {
                type: 'error',
                text: 'Your Microsite Id must consist of letters/and or numbers and must be a length 3 to 16 characters.'
            },
            'creditcard0': {
                type: 'error',
            ...
            'expirationdata0': {
                type: 'error',
                text: 'Invalid Expiration Date. Correct format: (mm/yyyy) '
            },
            'state0': {
                type: 'error',
                text: 'You must select a State.'
            },
            'zipcode0': {
                type: 'error',
    ...
    options.jq(function() {
        ...
        function getInstance(key) {
            if (object_instances.hasOwnProperty(key)) {
        ...
        function fd3_check_error(e, callback) {
            ...
            var result, msg, eId, msgId, FD3Message;

            result = callback.call(this, options.jq(e).val());

            msg = getMessage(result);
            eId = e.id;

            FD3Message = $.win.FD3Message;
        ...
        FORMS.Validate = {
            ...
            CreditCard: function(cc_num) {
                ...
                // Get the first digit
                var i, num, fn, regexp, map, sum, last, mapIndex, charr;
            ...
            CreditCard_V2: function(cc_num) {
                // Check for valid credit card type/number
                // Get the first digit
                var i, num, fn, regexp, map, sum, last, mapIndex, charr, x;
            ...
            Password: function(passwd) {
                var points, has_letter_exp, has_caps_exp, has_numbers_exp, letter, caps, numbers;
                
                points = passwd.length;
                
                has_letter_exp = new RegExp("[a-z]");
                has_caps_exp = new RegExp("[A-Z]");
                has_numbers_exp = new RegExp("[0-9]");

                letter = has_letter_exp.test(passwd);
                caps = has_caps_exp.test(passwd);
                numbers = has_numbers_exp.test(passwd);

                if (passwd.length === 0) {
                    return 'password1';
                } else if (passwd.length < 8) {
                    return "password2";
                } else if (!(letter && caps && numbers)) {
                    return "password4";
                } else if ((letter && caps && numbers)) {
                    return 'password0';
                } else {
        ...
        var AMPPromoInfoModel = FD3Model.extend({
            ...
            'eventsFired': function(e) {
                ...
                if (id == 'fd3_form_apply_promo_btn') {
                    ...
                    (function(controller, field) {
                        ...
                        var packagedData = {
                            'action': my_AMP_Ajax.promoAction,
                            "nonce": my_AMP_Ajax.promoNonce,
                            "process_amp_promo": my_AMP_Ajax.formPromo,
                            "fd3_form_promocode": options.jq(field).val()
                        };
            ...
            'validateFields': function() {
                ...
                var fields = [
                    {
                        "field_name": "fd3_form_phone",
                        "validate": FORMS.Validate.PhoneStr,
                        "required": true,
                        "instance": options.jq("#fd3_form_phone"),
            ...
            'eventsFired': function(e) {
                ...
                if (id == 'fd3_form_apply_promo_btn') {
                    ...
                    (function(controller, field) {
                        ...
                        var promoCode = jq(field).val();
                        var packagedData = {
                            'action': my_AP_Ajax.promoAction,
                            "nonce": my_AP_Ajax.promoNonce,
                            "process_ap_promo": my_AP_Ajax.formPromo,
                            "fd3_form_promocode": options.jq(field).val()
                        };
        ...
        var ContactInfoModel = FD3Model.extend({
            ...
            'validateFields': function() {
                ...
                var fields = [
                    {
                        "field_name": "fd3_form_company",
                        "validate": FORMS.Validate.CompanyName,
                        "required": false,
                        "instance": options.jq("#fd3_form_company"),
                        "message": ""
                    },
                    {
                        "field_name": "fd3_form_fname",
                        "validate": FORMS.Validate.FullName,
                        "required": true,
                        "instance": options.jq("#fd3_form_fname"),
                        "message": "Invalid First Name"
                    },
                    {
                        "field_name": "fd3_form_lname",
                        "validate": FORMS.Validate.FullName,
                        "required": true,
                        "instance": options.jq("#fd3_form_lname"),
                        "message": "Invalid Last Name"
                    },
                    {
                        "field_name": "fd3_form_email",
                        "validate": FORMS.Validate.Email,
                        "required": true,
                        "instance": options.jq("#fd3_form_email"),
        ...
        var AccountInfoModel = FD3Model.extend({
            ...
            'validateFields': function() {
                ...
                var fields = [
                    {
                        "field_name": "fd3_form_microsite_id",
                        "validate": FORMS.Validate.MicrositeId,
                        "required": true,
                        "instance": options.jq("#fd3_form_microsite_id"),
                        "message": "Invalid Microsite Id"
                    },
                    {
                        "field_name": "fd3_form_password",
                        "validate": FORMS.Validate.Password,
                        "required": true,
                        "instance": options.jq("#fd3_form_password"),
        ...
        var PreferencesInfoModel = FD3Model.extend({
            ...
            'validateFields': function() {
                ...
                var fields = [
                    {
                        "field_name": "fd3_personal_emails_permission_checkbox",
                        "validate": FORMS.Validate.isGroupChecked,
                        "required": true,
                        "use_object": true,
                        "instance": options.jq("#fd3_personal_emails_permission_checkbox"),
                        "message": "You must check the User Agreement"
                    },
                    {
                        "field_name": "fd3_newsletter_emails_permission_checkbox",
                        "validate": FORMS.Validate.isGroupChecked,
                        "required": true,
                        "use_object": true,
                        "instance": options.jq("#fd3_newsletter_emails_permission_checkbox"),
                        "message": "You must check the Cancellation Policy "
                    }
                ];
        ...
        var AgreementsInfoModel = FD3Model.extend({
            ...
            'validateFields': function() {
                ...
                var fields = [
                    {
                        "field_name": "fd3_user_agreement_checkbox",
                        "validate": FORMS.Validate.isChecked,
                        "required": true,
                        "use_object": true,
                        "instance": options.jq("#fd3_user_agreement_checkbox"),
                        "message": "You must check the User Agreement"
                    },
                    {
                        "field_name": "fd3_spam_agreement_checkbox",
                        "validate": FORMS.Validate.isChecked,
                        "required": true,
                        "use_object": true,
                        "instance": options.jq("#fd3_spam_agreement_checkbox"),
                        "message": "You must check the CAN-SPAM Compliance Agreement"
                    },
                    {
                        "field_name": "fd3_cancel_policy_agreement_checkbox",
                        "validate": FORMS.Validate.isChecked,
                        "required": true,
                        "use_object": true,
                        "instance": options.jq("#fd3_cancel_policy_agreement_checkbox"),
                        "message": "You must check the Cancellation Policy "
                    }
                ];
                ...
                if (id == 'link-to-subscribe') {
                    ...
                    if (this.validateFields()) {
                        ...
                        var fields = [
                            ...
                            {
                                "field_name": "fd3_form_promocode",
                                "validate": FORMS.Validate.Promocode,
                                "required": false,
                                "use_object": true,
                                "instance": options.jq("#fd3_form_promocode")
                            },
                            {
                                "field_name": "fd3_form_address1",
                                "validate": FORMS.Validate.FullName,
                                "required": true,
                                "use_object": true,
                                "instance": options.jq("#fd3_form_address1"),
                                "message": "Invalid Address."
                            },
                            {
                                "field_name": "fd3_form_address2",
                                "validate": FORMS.Validate.FullName,
                                "required": false,
                                "use_object": true,
                                "instance": options.jq("#fd3_form_address2")
                            },
                            {
                                "field_name": "fd3_form_city",
                                "validate": FORMS.Validate.FullName,
                                "required": true,
                                "use_object": true,
                                "instance": options.jq("#fd3_form_city"),
                                "message": "Invalid City is required."
                            },
                            {
                                "field_name": "fd3_form_state",
                                "validate": FORMS.Validate.selectedIndex,
                                "required": true,
                                "use_object": true,
                                "instance": options.jq("#fd3_form_state"),
                                "message": "State is required."
                            },
                            {
                                "field_name": "fd3_form_zipcode",
                                "validate": FORMS.Validate.Zipcode,
                                "required": true,
                                "use_object": true,
                                "instance": options.jq("#fd3_form_zipcode"),
                                "message": "Invalid Zipcode."
                            },
                            {
                                "field_name": "fd3_form_cc_cardholdername",
                                "validate": FORMS.Validate.FullName,
                                "required": true,
                                "use_object": true,
                                "instance": options.jq("#fd3_form_cc_cardholdername"),
                                "message": "Invalid Card Holder Name."
                            },
                            {
                                "field_name": "fd3_form_cc_cardno",
                                "validate": FORMS.Validate.CreditCard_V2,
                                "required": true,
                                "use_object": true,
                                "instance": options.jq("#fd3_form_cc_cardno"),
                                "message": "Invalid Card."
                            },
                            {
                                "field_name": "fd3_form_cc_expdate",
                                "validate": FORMS.Validate.ExpirationDate,
                                "required": true,
                                "use_object": true,
                                "instance": options.jq("#fd3_form_cc_expdate"),
                        ...
                        fields.forEach(function(field) {
                            ...
                            if (name == "fd3_form_cc_cardno") {
                                ...
                                var ccv2 = {
                                    "field_name": "fd3_form_cc_cvv2",
                                    "validate": FORMS.Validate.CVV3_V2,
                                    "required": true,
                                    "use_object": true,
                                    "instance": options.jq("#fd3_form_cc_cvv2"),
        ...
        var ContactInfoController = FD3Controller.extend({
            'index': function(data) {
                ...
                contactInfo.init({
                    ...
                    'views': {
                        'contactInfo': new ContactInfoView()
                    },
        ...
        var PreferencesInfoController = FD3Controller.extend({
            'index': function(data) {
                ...
                preferencesInfo.init({
                    ...
                    'views': {
                        'preferencesInfo': new PreferencesInfoView()
                    },
        ...
        var AgreementsInfoController = FD3Controller.extend({
            'index': function(data) {
                ...
                agreementsInfo.init({
                    ...
                    'views': {
                        'agreementsInfo': new AgreementsInfoView()
                    },
        ...
        var InvoiceInfoController = FD3Controller.extend({
            'index': function(data) {
                ...
                invoiceInfo.init({
                    'contents': data.InvoiceInfoData,
                    'views': {
                        'invoiceInfo': new InvoiceInfoView()
                    }
                });
                        ...
                        "children": [
                            {
                                ...
                                "children": [

                                    {
                                        "element": "div",
                                        "props": {
                                            "id": "product-one-container",
                                            "class": "signup-product product-one-container"
                                        },
                                        "has_children": true,
                                        "children": [

                                            {
                                                "element": "div",
                                                "props": {
                                                    "class": "fd3-image-container center-content"
                                                },
                                                "has_children": true,
                                                "children": [
                                                    {
                                                        ...
                                                        "props": {
                                                            "class": "signup-image",
                                                            "src": "/wp-content/plugins/fd3-dynamic-pages/assets/images/page_templates/signup/aq2e-platform-signup-box.png"
                                                        },
                                                        "has_children": false
                                                    }
                                ]
...

                                            {
                                                "element": "div",
                                                "props": {
                                                    "class": "fd3-product-desc-container"
                                                },
                                                "has_children": true,
                                                "children": [
                                                    {
                                                        "element": "span",
                                                        "contents": "Sign me up for the AQ2E Quote Engine Platform for only $20/month",
                                                        "props": {
                                                            "class": "fd3-product-desc"
                                                        },
                                                        "has_children": false
                                                    }
                                ]
...

                            {
                                ...
                                "children": [

                                    {
                                        "element": "div",
                                        "props": {
                                            "id": "product-two-container",
                                            "class": "signup-product product-two-container"
                                        },
                                        "has_children": true,
                                        "children": [
                                                ...
                                                "children": [
                                                    {
                                                        ...
                                                        "props": {
                                                            "class": "signup-image",
                                                            "src": "/wp-content/plugins/fd3-dynamic-pages/assets/images/page_templates/signup/aq2e-marketing-platform-signup-box.png"
                                                        },
                                                        "has_children": false
                                                    }
                                ]
...

                                            {
                                                ...
                                                "children": [
                                                    {
                                                        "element": "span",
                                                        "contents": "Yes, sign me up the complete AQ2E Marketing Platform which includes the AQ2E Quote Engine Platform for only $79/month.",
                                                        "props": {
                                                            "class": "fd3-product-desc"
                                                        },
                                                        "has_children": false
        ...
        var SignUpChoiceView = FD3View.extend({
            'renderTitle': function() {
                var d = this.renderElement('div', {
                    'class': 'form-group'
                });
                var h = this.renderElement('h2', {
                    'class': 'fd3-form-title'
                });
        ...
        var InvoiceInfoView = FD3View.extend({
            ...
            'renderTable': function() {
                ...
                t = this.renderElement('table', {
                    'class': 'table table-responsive table-bordered'
                });
                
                tb = this.renderElement('tbody');
                h = this.renderTableHeader();

                h.appendTo(t);

                for (i = 0; i < this.items.length; i++) {
                    item = this.renderItem(this.items[i]);
                    item.appendTo(tb);
                }

                for (i = 0; i < this.promoItems.length; i++) {
                    item = this.renderItem(this.promoItems[i]);
                    item.appendTo(tb);
                }
            ...
            'renderTableHeader': function() {
                ...
                th = this.renderElement('thead');
                tr = this.renderElement('tr');

                td1 = this.renderElement('th', {
                    'class': 'head',
                    'style': 'border:none'
                });
                td2 = this.renderElement('th', {
                    'class': 'head',
                    'style': 'border:none'
                });
                td3 = this.renderElement('th', {
                    'class': 'head',
                    'style': 'border:none'
                });
                td4 = this.renderElement('th', {
                    'class': 'head',
                    'style': 'border:none'
                });
            ...
            'renderSubtotal': function() {
                ...
                var sp1 = this.renderElement('span', {
                    'class': 'border-none col'
                });
                var s = this.renderElement('strong');
                var sp2 = this.renderElement('span', {
                    'class': 'border-none col'
                });
            ...
            'renderItem': function(i) {
                ...
                tmpCol = this.renderColumn(i.desc, {
                    "class": "col"
                });
                tmpCol.appendTo(tr);

                tmpCol = this.renderColumn(i.qty, {
                    "class": "col"
                });
                tmpCol.appendTo(tr);

                tmpCol = this.renderColumn('&dollar;' + this.moneyFormat(i.cost), {
                    "class": "col"
                });
                tmpCol.appendTo(tr);
        ...
        var AMPPromoInfoView = FD3View.extend({
            ...
            'renderPromo': function($promocode) {
                ...
                var l = this.renderElement('label', {
                    'for': 'fd3_form_promocode',
                    'id': 'fd3_form_promocode_label',
                    'data-original': 'PROMO CODE'
                });
                var i = this.renderInput({
                    'type': 'text',
                    'id': 'fd3_form_promocode',
                    'class': 'fd3-form-control input-lg',
                    'name': 'fd3_form_promocode',
                    'state': 'billing_info',
                    'form_group': 'promocode_id',
