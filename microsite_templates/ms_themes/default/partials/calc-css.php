...
.thumb-box4 {
  ...
  background-image: url("<?= get_template_directory_uri(); ?>/img/nexus2cee_Fill-Sign-App-With-Paper-Form.jpg");
...
.thumb-testbox1 {
  ...
  background-image: url("<?= get_template_directory_uri(); ?>/img/dell-venue-8-pro-apple-wireless-keyboard-medion-md86853-size-comparison.jpg");
  background-position: 100% top;
  background-size: cover
}
...
.about-us-container .about-us .left-container .badge-container .photo {
  ...
  border-radius: 50%;
  display: block;
  background: url("<?= get_template_directory_uri(); ?>/img/page3_pic9.jpg") no-repeat;
  margin: 0 auto
}
...
#totalNeededBigDisplay {
	position: relative;			
}

#totalNeededBigDisplay a {
	position: absolute;
}
