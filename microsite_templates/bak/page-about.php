...
--><!--	                                                <p class="description">
	...
	<script>
	  function include(url){ 
	    src = '<?= get_dynamic_pages_template_directory_uri() ?>/js/'+ url;
	    s = '<script src="' + src + '">';
	    s = s + '<\/script>';
	...
	<script>
		...
		jQuery(function() {
		  ...
		  $slider.create('about-header-banner', 'image', 'rate', 'banner');  
...
<script type='text/javascript' src="<?= get_dynamic_pages_template_part() . '/js/jquery.js?ver=1.0.0'; ?>"></script>
