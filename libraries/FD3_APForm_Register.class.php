...
class FD3_APForm_Register extends Wordpress_Extendable_Form {
    ...
    public function process_ap_registration() {
	        ...
	        if( isset( $_POST[ 'existing_user' ] ) && $_POST[ 'existing_user' ] == true ) {
		      ...
		      //  $affiliateId = 'aqterm';
		       ...
		       // $membership->addSite();
                ...
                // https://aqterm.com/aqterm-engine/index.php/aqmprocess
