...
// point to vendor's APIs
	...
	define( $FD3_PLUGIN_NAME . '_VENDOR_APIS' , FD3_DYNAMIC_PAGES_PLUGIN_APIS_ROOT . '\\' . 'Vendors' );

// point to rules
	define( $FD3_PLUGIN_NAME . '_RULES' , FD3_DYNAMIC_PAGES_PLUGIN_DIR . 'libraries\\rules' );
	
	define( $FD3_PLUGIN_NAME . '_URI' , '/wp-content/plugins/fd3-dynamic-pages/' );
	define( $FD3_PLUGIN_NAME . '_VERSION' , '1.0.0' );
	
	include_once( FD3_DYNAMIC_PAGES_PLUGIN_CLASSES . DIRECTORY_SEPARATOR . 'FD3ClassType.class.php' );
	...
	// make sure loader is available to fd3-functions
	include_once( FD3_DYNAMIC_PAGES_PLUGIN_DIR . DIRECTORY_SEPARATOR . 'fd3-functions.php' );
	
/*	$fd3_loader->load->component('aqterm_front', null, 'aqterm_front' );
	$fd3_loader->aqterm_front->controller->render();*/
	
/*	$fd3_loader->load->component('form', null, 'dynamic_form' );
	$fd3_loader->dynamic_form->controller->render();*/
...
/*	$fd3_loader->load->controller('Test', 'test_controller' );*/
	...
	add_action(
		...
		global $fd3_loader;
		$fd3_loader->load->library( 'FD3DynamicPagesPlugin', null, 'plugin' );
		$fd3_loader->plugin->run();
