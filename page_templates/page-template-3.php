                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                           ...
                           <h3 class="contents-header">Life events often trigger the decision to Buy or Sell a Home</h3>
			
																											<h2 class="contents-header">Life Events</h2>
                           <p class="contents-text-2">The decision to sell or Buy a home is generally prefaced by at least one of several life events that happen during the 24 months leading up to a sale. These most often include job changes and promotions (26 percent), shifts in financial status (24 percent), retirement (16 percent), or changes to the number of people in a household due to a birth, death, marriage, divorce, becoming empty nesters, or other factors.</p>
			
																											<!--<h3 class="contents-header">Of course if you let me help you, I will make the process even easier for you.</h3>-->
