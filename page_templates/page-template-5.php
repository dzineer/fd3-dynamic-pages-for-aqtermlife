                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
																										...
																										<ul class="fa-ul">
																													<li><i class="fa-li fa fa-check"></i>Marriage</li>
																													<li><i class="fa-li fa fa-check"></i>Baby</li>
																													<li><i class="fa-li fa fa-check"></i>Home Purchase</li>
																													<li><i class="fa-li fa fa-check"></i>Job Change</li>
																													<li><i class="fa-li fa fa-check"></i>Retirement</li>
																													<li><i class="fa-li fa fa-check"></i>or Your Small Business Has Grown</li>
																										</ul>
			
																										<p class="contents-text-2">...could trigger the need for life insurance or trigger the need for a life insurance check up.</p>
																										<p class="contents-text">Often there are legitimate planning issues for making changes in life insurance coverage. Our Needs Analyzer can help you determine how much life insurance is right for you.</p>
																										<h3 class="contents-header">Let me provide you with this helpful guide.</h3>
                                    ...
                                    <form method="post" id="currentForm">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <? } else { ?>    
                                                ...
                                                <a class="btn btn-primary btn-block btn-lg fd3-subscribe-btn submit-btn form-control" style="background-color: #c26800 !important;border-color: #b86300 !important;"><?= $page_details['form']['button_text'] ?></a>
...
<script>
			...
			<style>
						...
						.btn-primary {
									background-image: linear-gradient(to bottom,#FF8900 0%,#c26800 100%) !important;
									filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#FFFF8900', endColorstr='#FFC26800', GradientType=0) !important;
									filter: progid:DXImageTransform.Microsoft.gradient(enabled = false) !important;
									background-repeat: repeat-x !important;
									border-color: #b86300 !important;
						...
						.btn-primary:active, .btn-primary.active {
									background-color: #c26800 !important;
									border-color: #b86300 !important;
						}
